...
const STRINGS = {
  ...
  'panel.handsfreeHint':{ en: 'Detect speech automatically instead of holding 🎤. Frees both hands, but a noisy room can cut you off.',
                          de: 'Sprache automatisch erkennen, statt 🎤 zu halten. Lässt beide Hände frei, kann dich in lauter Umgebung aber abschneiden.' },
  ...
  // -- Voice -----------------------------------------------------------------
  'voice.holdHint':     { en: 'Hold 🎤 while you talk, then let go — I answer out loud.',
                          de: 'Halte 🎤 gedrückt, während du sprichst, und lass dann los — ich antworte laut.' },
  'voice.arming':       { en: '🎤 …',                       de: '🎤 …' },
  'voice.micArmed':     { en: 'Mic ready — hold 🎤 and ask.',
                          de: 'Mikrofon bereit — halte 🎤 und frag.' },
  'voice.micOff':       { en: 'Mic off. Tap or hold 🎤 to talk again.',
                          de: 'Mikrofon aus. Tippe oder halte 🎤, um wieder zu sprechen.' },
  ...
  'voice.handsfreeOff': { en: 'Hands-free off — hold 🎤 to talk.',
                          de: 'Freihändig aus — halte 🎤 zum Sprechen.' },
