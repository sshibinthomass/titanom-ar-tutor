...
const STRINGS = {
  ...
  'panel.handsfree':    { en: 'Hands-free mic',             de: 'Freihändiges Mikrofon' },
  'panel.handsfreeHint':{ en: 'Detect speech automatically instead of holding the mic button. Frees both hands, but a noisy room can cut you off.',
                          de: 'Sprache automatisch erkennen, statt die Mikrofontaste zu halten. Lässt beide Hände frei, kann dich in lauter Umgebung aber abschneiden.' },
  ...
  'panel.theme':        { en: 'Theme',                      de: 'Design' },
  'btn.controls':       { en: 'Controls',                      de: 'Steuerung' },
  'btn.dark':           { en: 'Dark',                          de: 'Dunkel' },
  'btn.light':          { en: 'Light',                         de: 'Hell' },
  ...
  'btn.micTitle':       { en: 'Voice needs a microphone plus an ElevenLabs or OpenAI key (or Chrome).',
                          de: 'Für die Sprachfunktion braucht es ein Mikrofon und einen ElevenLabs- oder OpenAI-Schlüssel (oder Chrome).' },
  ...
  'explore.intro':      { en: 'Tap any part to isolate it, then hold the mic button and ask about it. Drag the slider to spread the parts apart.',
                          de: 'Tippe ein Teil an, um es freizustellen, dann halte die Mikrofontaste und frag danach. Mit dem Regler ziehst du die Teile auseinander.' },
  'explore.partCount':  { en: '{count} parts',              de: '{count} Teile' },
  'explore.partMeta':   { en: '{tris} triangles · hold the mic to ask about it',
                          de: '{tris} Dreiecke · Mikrofon halten und fragen' },
  'explore.groupMeta':  { en: '{count} pieces · hold the mic to ask about it',
                          de: '{count} Einzelstücke · Mikrofon halten und fragen' },

  // -- Fix -------------------------------------------------------------------
  'fix.ask':            { en: 'What should we fix?',        de: 'Was sollen wir reparieren?' },
  'fix.askHint':        { en: 'Hold the mic button and describe the problem — or pick one below.',
                          de: 'Halte die Mikrofontaste und beschreibe das Problem — oder wähle unten eines aus.' },
  ...
  'voice.handsfreeOff': { en: 'Hands-free off — hold the mic button to talk.',
                          de: 'Freihändig aus — halte die Mikrofontaste zum Sprechen.' },
  ...
  'voice.micBlocked':   { en: 'Microphone blocked — allow mic access for this site and tap the mic button again.',
                          de: 'Mikrofon blockiert — erlaube den Mikrofonzugriff für diese Seite und tippe erneut auf die Mikrofontaste.' },
